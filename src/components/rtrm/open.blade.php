<div>
    ...
    <form action="{{route('fmt.rtrm.store')}}" method="post" class="fmt_box">
        ...
        <div>
            ...
            <textarea class="fmt_input" name="question" id="" cols="30" rows="5" required></textarea>
        </div>
        ...
        <div class="fmt_flex">
            <div>
                <label class="fmt_label" for="">Answer in English</label>
                <textarea class="fmt_input" name="answer_english" id="" cols="30" rows="5"></textarea>
            </div>
        </div>
        {{-- //answer2-arrange2 --}}
        {{-- answer2-arrange2 --}}
        <div class="fmt_flex">
            <div>
                <label class="fmt_label" for="">Answer in Hindi</label>
                <textarea class="fmt_input" name="answer_hindi" id="" cols="30" rows="5"></textarea>
            </div>
        </div>
        {{-- //answer2-arrange2 --}}
        <div>
